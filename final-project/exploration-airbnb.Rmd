...
Let's see how has been the evolution of the creation of Airbnb accounts, we will see that is a popular service that gas gaining sustained subscription over time
```{r, echo=FALSE}
...
### How the channels for signing in are distributed?
Is people from a particular signup method more prone to book?
```{r, echo=FALSE}
ggplot(df, aes(df$date_account_created)) + 
...
We want to see if older subscritors tend to book in shorter time? 
